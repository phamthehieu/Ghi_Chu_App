...
@Database(
    entities = [Icons::class, Category::class], version = 3, exportSchema = false)
abstract class IncomeAndExpenditureDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        private suspend fun insertSampleData(categoryDao: CategoryDao, iconDao: IconsDao) {
            val iconList = mutableListOf<Icons>()

            for (i in 1..15) {
                iconList.add(Icons(iconResource = "icons/giaiTri/giaiTri$i.png", type = "GiaiTri"))
                iconList.add(Icons(iconResource = "icons/doAn/doAn$i.png", type = "DoAn"))
                iconList.add(Icons(iconResource = "icons/muaSam/muaSam$i.png", type = "MuaSam"))
                iconList.add(Icons(iconResource = "icons/cuocSong/cuocSong$i.png", type = "CuocSong"))
                iconList.add(Icons(iconResource = "icons/caNhan/caNhan$i.png", type = "CaNhan"))
                iconList.add(Icons(iconResource = "icons/duLich/duLich$i.png", type = "DuLich"))
                iconList.add(Icons(iconResource = "icons/giaoDuc/giaoDuc$i.png", type = "GiaoDuc"))
                iconList.add(Icons(iconResource = "icons/ngayHoi/ngayHoi$i.png", type = "NgayHoi"))
                iconList.add(Icons(iconResource = "icons/sucKhoe/sucKhoe$i.png", type = "SucKhoe"))
                iconList.add(Icons(iconResource = "icons/taiChinh/taiChinh$i.png", type = "TaiChinh"))
                iconList.add(Icons(iconResource = "icons/theThao/theThao$i.png", type = "TheThao"))
                iconList.add(Icons(iconResource = "icons/vanPhong/vanPhong$i.png", type = "VanPhong"))
                iconList.add(Icons(iconResource = "icons/phuongTien/phuongTien$i.png", type = "PhuongTien"))
                iconList.add(Icons(iconResource = "icons/khac/khac$i.png", type = "Khac"))
                iconList.add(Icons(iconResource = "icons/thuCung/thuCung$i.png", type = "ThuCung"))
                iconList.add(Icons(iconResource = "icons/treEm/treEm$i.png", type = "TreEm"))
            }

            for (i in 1..21) {
                iconList.add(Icons(iconResource = "icons/iconDanhMucMau/mau$i.png", type = "Mau"))
            }
